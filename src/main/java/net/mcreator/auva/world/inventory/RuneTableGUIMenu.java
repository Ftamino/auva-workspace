...
package net.mcreator.auva.world.inventory;
...
public class RuneTableGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public RuneTableGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(AuvaModMenus.RUNE_TABLE_GUI, id);
		...
		for (int si = 0; si < 3; ++si)
			for (int sj = 0; sj < 9; ++sj)
				this.addSlot(new Slot(inv, sj + (si + 1) * 9, 28 + 8 + sj * 18, 33 + 84 + si * 18));
		for (int si = 0; si < 9; ++si)
			this.addSlot(new Slot(inv, si, 28 + 8 + si * 18, 33 + 142));
	}
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof RuneTableGUIMenu) {
